...
$langmk['ad_save'] = "Save";
$langmk['ad_saved'] = "Saved Successfully";
$langmk['ad_savednews'] = "News Saved Successfully";
$langmk['ad_deleted'] = "Deleted Successfully";
...
$langmk['ad_noperms'] = "You are not authorized to enter the Admin Control Panel.";

//ad_main
$langmk['ad_boardname'] = "<b>Board Installed</b><br />(Edit conf_mk.php to change)";
$langmk['sitename'] = "<b>Site Name</b>";
$langmk['ad_siteurl'] = "<b>Site URL</b><br />(Edit conf_mk.php to change)";
$langmk['ad_skin'] = "<b>Skin &amp; Templates</b>";
$langmk['ad_language'] = "<b>Languages</b>";
$langmk['ad_langm'] = "Management";
$langmk['ad_lang'] = "<b>Language</b>";
$langmk['ad_fpath'] = "<b>Forum Path</b><br />(Edit conf_mk.php to change)";
$langmk['ad_mkview'] = "<b>MKPortal view</b>";
$langmk['ad_mkviewsmall'] = "Set Size";
$langmk['ad_mkviewlarge'] = "Full Page";
$langmk['ad_forumview'] = "<b>Forum View</b>";
$langmk['ad_forumin'] = "Show Forum inside MKPortal?";
$langmk['ad_forumout'] = "Outside";
$langmk['ad_rightcolumn'] = "<b>Close Right column?</b><br />While browsing Forum";
$langmk['ad_leftcolumn'] = "<b>Close Left column?</b><br />While browsing Forum";
$langmk['ad_sytime'] = "<b>Mkportal and Board time synchronization</b>";
$langmk['ad_curtime'] = "MKPortal current date and time:";
$langmk['ad_diftime'] = "Board hour diff:";
$langmk['ad_powidth'] = "<b>Total width of Portal</b><br />Pixels: Min. 780px, Max. 1600px<br />Percent: Min. 75%, Max. 100%";
$langmk['ad_cowidth'] = "<b>Lateral Columns Width</b><br />Min. 120px, Max. 280px";
...
$langmk['ad_refblog'] = "Static Blog redirect files successfully regenerated.";
$langmk['ad_refblogconfirm'] = "Do you really want to overwrite your Blog static redirect pages?";
$langmk['ad_blogrefresh'] = "<b>Regenerate Static Blog redirect pages.</b><br /><br />This option is useful if you move your MKPortal installation to a new site or a new directory.<br />Clicking \"Regenerate\" will overwrite all static blog redirect pages with the new URLs.<br />These static html pages can be found in mkportal/blog/";
$langmk['ad_refsubmit'] = "Regenerate";
...
$langmk['ad_chatnote'] = "Note: To use the Chat module you must first register a channel with the IRC network of your choice.<br />Default values for Server, Port, and Channel are for example purposes only.";
...
$langmk['ad_newsnew'] = "Add News";
$langmk['ad_newsedit'] = "Edit News";
$langmk['ad_newsedit2'] = "Enter news article ID and submit";
$langmk['ad_newsfilt'] = "To add or edit unfiltered news articles in the Portal CP use the BBcode editor.<br />The html editor filters content for security reasons.<br />Set editor preference in Portal CP &gt; <a href=\"index.php\">Preferences</a> before adding articles.";
...
$langmk['ad_p_accdown'] = "Can View Downloads Area?";
$langmk['ad_p_dlfiles'] = "Can Download Files?";
...
$langmk['ad_p_accquote'] = "Can view Quotes?";
...
$langmk['ad_urlomax'] = "Maximum number of shouts to store in the database";
$langmk['ad_urloblock'] = "Number of shouts to display in the block";
...
$langmk['ad_disablezip'] = "<b>Disable gzip compression?</b>";

//added in M1.0
$langmk['ad_groupsallow'] = "Groups allowed to access:";
$langmk['ad_sbllist'] = "System Blocks List";
$langmk['ad_pagenewh'] = "Create Html page";
$langmk['ad_pagenewp'] = "Create Php page";
$langmk['ad_pgpreview'] = "Page Preview";
$langmk['ad_targetnew'] = "Open this link in a new window";
$langmk['ad_disablenav'] = "<b>Hide links nav-bar?</b>";
$langmk['ad_rssnews'] = "Rss News";
$langmk['ad_maxim_bg'] = "Maximum number of Images allowed in personal gallery?";
$langmk['ad_maxim_bgl'] = "Maximum File Size in Kb for each image in personal gallery?";

$langmk['ad_mbtitles'] = "Titles";
$langmk['ad_bdeflang'] = "Default Titles";
$langmk['ad_bthlang'] = "Language Titles";
$langmk['ad_preferencet1'] = "Sitename &amp; Paths";
$langmk['ad_preferencet2'] = "General Configuration";
$langmk['ad_preferencet3'] = "Mkportal Global Look &amp; Feel";
$langmk['ad_preferencet4'] = "Forum page Look &amp; Feel";
$langmk['ad_load_leftc'] = "<b>Load left column?</b><br />Globally";
$langmk['ad_load_rightc'] = "<b>Load right column?</b><br />Globally";
$langmk['ad_urightcolumn'] = "<b>Unload Right column?</b><br />While browsing Forum";
$langmk['ad_uleftcolumn'] = "<b>Unload Left column?</b><br />While browsing Forum";
$langmk['ad_havesubcat'] = "Cannot delete this category unless all its subcategories have been deleted.";
$langmk['ad_foot_logo'] = "<b>Show MKPortal logo (loghino.gif) in footer?</b>";
$langmk['ad_foot_version'] = "<b>Show version number in footer?</b>";
$langmk['ad_foot_debug'] = "<b>Show debug info in footer?</b>";
$langmk['ad_referer'] = "<b>Disable HTTP_REFERER Check for Portal CP?</b>";
$langmk['ad_fopen_error'] = "<b>Cannot open the file /cache/tmp_block.php. Check the CHMOD (0777) of /cache/tmp_block.php and confirm that your server supports the PHP \"fopen\" function.</b>";
$langmk['ad_adminpath'] = "<b>Admin Path</b><br />(Edit conf_mk.php to change)";
$langmk['ad_cp_tpl'] = "<b>Use \"default\" template in Portal CP?</b><br />Recommended when using narrow Portal templates.";
$langmk['ad_tools'] = "Tools";
$langmk['ad_phpinfo'] = "PHP Info";
$langmk['ad_nophpinfo'] = "The phpinfo() function is disabled on your server.";
$langmk['ad_warninstall'] = "WARNING! The Install Script has not been deleted from the server. This is an extreme security risk! Delete /mkportal/mk_install.php immediately!";
$langmk['ad_warnupgrade'] = "WARNING! The Upgrade Directory has not been deleted from the server. This is an extreme security risk! Delete the /mkportal/upgrades directory immediately!";
$langmk['ad_noicons'] = "<b>Use graphic icons in navigation links?</b>";
$langmk['ad_notitle'] = "Title field is empty. Please go back and add a title.";
$langmk['ad_nocontent'] = "Content field is empty. Please go back and add content.";
$langmk['ad_security'] = "Security";
$langmk['ad_preferencecp'] = "Portal CP Preferences";
$langmk['ad_postwhitelist'] = "<b>\"POST\" Whitelist</b><br />Enter allowed domains in the format \".example.com\"<br />Separate multiple domains with commas.";
$langmk['ad_metadesc'] = "<b>Meta Description</b><br />A short description of your website.";
$langmk['ad_metakey'] = "<b>Meta Keywords</b><br />Separate multiple keywords with commas.";
$langmk['ad_clthumbs'] = "Use Ajax or Classic thumbnails in section view?";
$langmk['ad_sqthumbs'] = "Use square thumbnails?";
$langmk['ad_thumbmax'] = "Max dimension for Thumbnails in pixels. Default is \"120\".";
$langmk['ad_thumbqual'] = "Thumbnail JPEG quality.<br />Valid range is from 0 (worst quality, smaller file) to 100 (best quality, biggest file). Default is \"90\".";
$langmk['ad_ajaxth'] = "Ajax";
$langmk['ad_classicth'] = "Classic";
$langmk['ad_badqual'] = "Range for JPEG quality is from 0-100. Please go back and enter a valid quality setting.";
$langmk['ad_type'] = "Type";
