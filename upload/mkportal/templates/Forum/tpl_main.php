...
<head>
  ...
  <link href="$mklib->template/rating.css" rel="stylesheet" type="text/css" media="all">
  {$js}
  {$pmk_js}
</head>
	...
	<tr align="left">
	  <td>	  
        ...
        <form id="editor2" name="editor2" onsubmit="return ajaxchatSubmit();">
                 ...
                 <centr>
          <input align="left" type="text" id="ta2" name="ta" style="width: 80%; border:1; padding: 4px; margin: 0;  background-color: #FFF;">
