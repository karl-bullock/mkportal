...
<!-- begin logostrip -->
	...
	<tr>
	  <td id="mklogostrip" style="background-image: url('$mklib->images/top_back.png')" width="100%">
          <a href="$mklib->siteurl/index.php"><img src="$mklib->images/logo.png" border="0" alt="" /></a>
          </td>
...
<!-- begin linkbar -->
	...
	<tr>
	  <td>
<table height="28" width="100%" border="0" style="background-image: url('$mklib->images/dwhc.gif')">
	      <tr>
		<td>
...
<table height="54" width="100%" border="0" style="background-image: url('$mklib->images/footer.gif')">
		<tr>
...
<tr>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<tr>
				  <td width="1%"><img src="$mklib->images/inf_left.png" border="0" />
				  </td>
				  <td class="sottotitolo" width="99%" style="background-image: url('$mklib->images/inf_back.png')" valign="middle" nowrap="nowrap">{$title}
				  </td>
				  <td width="1%"><img src="$mklib->images/inf_right.png" border="0"/>
				  </td>
				</tr>
			      </table>
			    </td>
