...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{$mklib->xml}" lang="{$mklib->xml}">
...
<!-- begin left column -->
		...
		<div id="menucontents" class="mkalign1" style="$mklib->menucontents">
		<div class="mkalign2"><a href="javascript:ColumnClose('menusx');MemoPos('MKmenusx', '1');"><img src="$mklib->images/f2.gif" border="0" alt="" /></a>&nbsp;</div>
		  <table cellpadding="0" cellspacing="2" border="0" style="width: {$mklib->columnwidth}px;">
		  {$blocks}
		  </table>
		</div>
		<div id="menucloseds" style="$mklib->menucloseds">
		<div class="mkalign2"><a href="javascript:ColumnOpen('menusx');MemoPos('MKmenusx', '0');"><img src="$mklib->images/f1.gif" border="0"  alt="" /></a></div>
		</div>
		</td>
...
<!-- begin column spacer -->
		...
		<td class="vspacer mkalign1" width="0%" style="background-image: url('$mklib->images/punto_vert.gif')"><img src="$mklib->images/punto_vert.gif" width="6" height="3" alt="" />
		</td>
...
function view_column_center($blocks, $blockc_top, $blockc_down) {
global $mklib;
return <<<EOF
...
<!-- begin right column -->
		...
		<div id="menucontentr" class="mkalign1" style="$mklib->menucontentr">
		<div class="mkalign1">&nbsp;<a href="javascript:ColumnClose('menudx');MemoPos('MKmenudx', '1')"><img src="$mklib->images/f1.gif" border="0" alt="" /></a></div>
		  <table cellpadding="0" cellspacing="2" border="0" style="width: {$mklib->columnwidth}px;">
		  {$blocks}
		  </table>
		</div>
		<div id="menuclosedr" style="$mklib->menuclosedr">
		<div class="mkalign1"><a href="javascript:ColumnOpen('menudx');MemoPos('MKmenudx', '0')"><img src="$mklib->images/f2.gif" border="0" alt="" /></a></div>
		</div>
		</td>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			    <td>
			      <table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
				  <td class="tdmenblock" align="right" style="width: 1%; line-height:10px"><img src="$mklib->images/m_sx2.gif" class="tdmenblock" alt="" />
				  </td>
				  <td class="tdmenblock" width="99%" style="background-image: url('$mklib->images/m_sf2.gif'); line-height:10px"><img src="$mklib->images/m_sf2.gif" border="0" class="tdmenblock" alt="" />
				  </td>
				  <td class="tdmenblock" style="width: 1%; line-height:10px"><img src="$mklib->images/m_dx2.gif" class="tdmenblock" alt="" />
				  </td>
				</tr>
			      </table>
			    </td>
