...
-------------------------------------------------------------------------*/
$ug_config['newver'] = 'R1.0.2'; //New MKPortal version number - change this for each new version
...
require "../lang/$MK_LANG/lang_global.php"; //Load lang file
...
<!-- begin document head -->
<head>
  <meta http-equiv=\"content-type\" content=\"text/html; charset={$langmk['charset']}\" />
...
function start() {
	...
	if (!in_array($mkp_version, $ug_config['goodver'])) {
		...
		$content .= "<form name=\"main\" method=\"post\" action=\"upgrade102.php?op=2\">
