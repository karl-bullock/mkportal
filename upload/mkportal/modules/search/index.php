...
<tr>
  <td>
	...
	<td width=\"80%\"><br /><br /><input class=\"bgselect\" type=\"text\" name=\"testo\" size=\"52\" /><br /></td>
      ...
      <tr>
	<td colspan=\"2\"><br /><br /><input class=\"mkbutton\" type=\"submit\" value=\"{$mklib->lang['sh_start']}\" /></td>
      </tr>
    </table>
    </form>
...
<tr>
  <td align=\"center\"><br /><br />
	...
	$mklib->printpage("1", "1", $mklib->sitename.$mklib->lang['tt_sep'].$mklib->lang['sh_titlepage'].$mklib->lang['tt_sep'].$mklib->lang['sh_titlesub'], $blocks);
	}


	function result_search() {
		global $mkportals, $DB, $mklib, $Skin;
		//$campo = intval($mkportals->input['campo']); //deprecated
		$testo = $mkportals->input['testo'];
		$campo = "content"; //This is a database table row name - Do not translate!
		if (intval($mkportals->input['campo']) == 2) {
			$campo = "title"; //This is a database table row name - Do not translate!
		}
		if (!$testo) {
...
<tr>
  <th class=\"modulex mkalign1\" width=\"80%\"><b>{$mklib->lang['sh_resultpt']}</b></td>
...
<tr>
  <td align=\"center\"><br /><br />
	...
	$mklib->printpage("1", "1", $mklib->sitename.$mklib->lang['tt_sep'].$mklib->lang['sh_titlepage'].$mklib->lang['tt_sep'].$mklib->lang['sh_titresult'], $blocks);
	}
}
?>
