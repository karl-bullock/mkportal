...
<table width="98%" align="center">
  <tr>
    <td align="center">
      <br /><br /><div align="center"><a href="http://www.mkportal.it" target="_blank">MKPDownloads</a> &copy;2003-2008 <a href="http://www.mkportal.it" target="_blank">mkportal.it</a></div>
    </td>
  </tr>
</table>
</td>
...
function row_entry($id, $name, $description, $trate, $rate, $width2, $width, $screens, $demo, $dlicon, $dllink, $autore, $peso, $rating) {
global $mkportals, $mklib;
...
if ($width > 0) {
    ...
    $scala = "<br /><img src=\"$mklib->images/spacer.gif\" width=\"{$width2}\" height=\"5\" alt=\"\" /><br /><img src=\"$mklib->images/scale.gif\" width=\"129\" alt=\"\" />";
}
return <<<EOF

<tr>
  <td class="modulecell mkalign1" width="20%" valign="top">{$mklib->lang['dw_name']}</td>
  <td class="modulecell mkalign1" width="80%"><b>{$name}</b></td>
</tr>
<tr>
  <td class="modulecell mkalign1" width="20%" valign="top">{$mklib->lang['dw_description']}</td>
  <td class="modulecell mkalign1" width="80%">{$description}</td>
</tr>

<tr>
  <td class="modulecell mkalign1" width="20%" valign="top">{$mklib->lang['dw_sendby']}</td>
  <td class="modulecell mkalign1" width="80%">{$autore}</td>
</tr>

<tr>
  <td class="modulecell mkalign1" width="20%" valign="top">{$mklib->lang['dw_dim']}</td>
  <td class="modulecell mkalign1" width="80%">{$peso}</td>
</tr>

<tr>
  <td class="modulecell mkalign1" width="20%" valign="top">{$mklib->lang['dw_score']}</td>
  <td class="modulecell mkalign1" width="80%">$rating</td>
</tr>
<tr>
  <td class="modulecell mkalign1" width="20%" valign="top">{$mklib->lang['dw_demourl']}</td>
  <td class="modulecell mkalign1" width="80%">$demo</td>
</tr>
<tr>
  <td class="modulecell mkalign1" width="20%" valign="top">{$mklib->lang['dw_screens']}</td>
  <td class="modulecell mkalign1" width="80%">$screens</td>
</tr>
<tr>
  <td class="modulecell" colspan="2">
    <table width="50%" align="center">
      <tr>
        <td align="center" class="functions" width="200">$dlicon</td>
	  </tr>
      <tr>
        <td align="center" class="functions" width="200">$dllink</td>
	  </tr>
    </table>
  </td>
</tr>
