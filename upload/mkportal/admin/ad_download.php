...
class mk_ad_download {
	...
	global $mkportals, $mklib, $Skin, $DB;
		...
		*/
		...
		$checksave = "{$mklib->lang['ad_dowsfileup']}";
   		}
	 	$content  = "
	...
	<tr>
	  <td>
	    ...
	    <form action=\"index.php?ind=ad_download&amp;op=save_main\" name=\"save_main\" method=\"post\">
	    ...
	    <form action=\"index.php?ind=ad_download&amp;op=add_event\" name=\"a_ev\" method=\"post\">
	    <table width=\"100%\" border=\"0\">
	      <tr>
		...
		<td><textarea cols=\"50\" rows=\"4\" name=\"descrizione\" class=\"bgselect\"></textarea></td>
	      ...
	      <tr>
		<td><input type=\"submit\" name=\"Inserisci\" value=\"{$mklib->lang['ad_insert']}\" class=\"mkbutton\" /></td>
	      </tr>
	    </table>
	    </form>
	    
	    <form action=\"index.php?ind=ad_download&amp;op=edit_event\" name=\"m_ev\" method=\"post\">
	    <table width=\"100%\" border=\"0\">
	      <tr>
	    ...
	    <form action=\"index.php?ind=ad_download&amp;op=delete_event\" name=\"e_ev\" method=\"post\">
	    <table width=\"100%\" border=\"0\">
	      <tr>
	    ...
	    <form action=\"index.php?ind=ad_download&amp;op=add_upped\" name=\"add_up\" method=\"post\">
	    <table width=\"100%\" border=\"0\">		
	      <tr>
		...
		$mklib->printpage_admin($mklib->lang['ad_titlepage'].$mklib->lang['tt_sep'].$mklib->lang['ad_dowtitle'], $output);
	...
	function add_event() {
		...
		$DB->close_db();
	 	Header("Location: index.php?ind=ad_download&mode=saved");
		exit;
  }
	function edit_event() {
   		global $mkportals, $mklib, $Skin, $DB;
	...
	<tr>
	  <td>
	    ...
	    <form action=\"index.php?ind=ad_download&amp;op=update_event\" name=\"EV_UPGRADE\" method=\"post\">
	    <table width=\"100%\" border=\"0\">
	      <tr>
		<td>
	...
	function save_main() {
		...
		$mod_downloads = intval($mkportals->input['stato']);
	...
	function add_upped() {
		...
		$this->update_total();
		$DB->close_db();
	 	Header("Location: index.php?ind=ad_download&mode=savedupped");
		exit;
  }
